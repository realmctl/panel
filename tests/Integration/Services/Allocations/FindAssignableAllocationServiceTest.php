...
namespace Realm\Tests\Integration\Services\Allocations;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('realm.client_features.allocations.range_start', 0);
        config()->set('realm.client_features.allocations.range_end', 0);
    }
    ...
    public function testNewAllocationIsCreatedIfOneIsNotFound()
    {
        ...
        config()->set('realm.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('realm.client_features.allocations.range_start', 5000);
        config()->set('realm.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('realm.client_features.allocations.range_start', 'hodor');
        config()->set('realm.client_features.allocations.range_end', 10);
        ...
        config()->set('realm.client_features.allocations.range_start', 10);
        config()->set('realm.client_features.allocations.range_end', 'hodor');
