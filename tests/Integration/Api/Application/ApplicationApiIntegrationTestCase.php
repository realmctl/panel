...
namespace Realm\Tests\Integration\Api\Application;
...
use Realm\Tests\Traits\Http\IntegrationJsonRequestAssertions;
...
abstract class ApplicationApiIntegrationTestCase extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this
            ->withHeader('Accept', 'application/vnd.realm.v1+json')
