...
import NestEggImportModal from '@/components/admin-preview/nests/NestEggImportModal';
    ...
    return (
        <>
            <NestEggImportModal
                ...
                onImported={(eggId) => {
                    mutate();
                    history.push(`${adminPreviewBasePath}/nests/eggs/${eggId}`);
                }}
            />
            ...
            <div className="overflow-hidden rounded-md border border-border bg-card">
                ...
                {nests.length === 0 ? (
                    <p className="px-5 py-8 text-sm text-muted-foreground">
                        No nests yet.{' '}
                        <Link
                            to={`${adminPreviewBasePath}/nests/new`}
