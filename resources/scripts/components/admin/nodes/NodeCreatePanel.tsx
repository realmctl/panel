...
import { SegmentedControl, SettingRow, SettingsSection } from '@/components/admin/settings/settingsLayout';
        ...
        createNode(form)
            .then((response: any) => {
                ...
                if (response.redirect === 'node') {
                    history.push(`${adminBasePath}/nodes/${response.node.id}`);
                } else {
                    history.push(`${adminBasePath}/nodes/${response.node.id}/allocation`);
                }
            })
            .catch((submitError) => {
            ...
            <form onSubmit={onSubmit} className="space-y-4 lg:col-span-3">
                ...
                <div className="flex items-center justify-between rounded-md border border-border bg-card px-5 py-4">
                    ...
                    <div className="flex gap-2">
                        <Link to={`${adminBasePath}/nodes`} className="no-underline">
