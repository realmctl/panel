...
const quickActions = [
    { label: 'New server', href: `${adminBasePath}/servers/new` },
    { label: 'New user', href: `${adminBasePath}/users/new` },
    { label: 'New node', href: `${adminBasePath}/nodes/new` },
    { label: 'New egg', href: `${adminBasePath}/nests/eggs/new` },
    { label: 'New database host', href: `${adminBasePath}/databases/new` },
    { label: 'Settings', href: `${adminBasePath}/settings` },
] as const;

const managementSections: ManagementSection[] = [
    { label: 'Settings', href: `${adminBasePath}/settings` },
    { label: 'API', href: `${adminBasePath}/api` },
    { label: 'Servers', href: `${adminBasePath}/servers`, statKey: 'servers' },
    { label: 'Users', href: `${adminBasePath}/users`, statKey: 'users' },
    { label: 'Nodes', href: `${adminBasePath}/nodes`, statKey: 'nodes' },
    { label: 'Locations', href: `${adminBasePath}/locations`, statKey: 'locations' },
    { label: 'Nests', href: `${adminBasePath}/nests`, statKey: 'nests' },
    { label: 'Mounts', href: `${adminBasePath}/mounts`, statKey: 'mounts' },
    { label: 'Databases', href: `${adminBasePath}/databases`, statKey: 'database_hosts' },
    { label: 'Subdomains', href: `${adminBasePath}/subdomains`, statKey: 'subdomain_domains' },
];

const overviewStats: { label: string; statKey: keyof OverviewStats; href: string }[] = [
    { label: 'Servers', statKey: 'servers', href: `${adminBasePath}/servers` },
    { label: 'Users', statKey: 'users', href: `${adminBasePath}/users` },
    { label: 'Nodes', statKey: 'nodes', href: `${adminBasePath}/nodes` },
    { label: 'Locations', statKey: 'locations', href: `${adminBasePath}/locations` },
];
                        ...
                        <div className="grid flex-1 grid-cols-1 sm:grid-cols-2">
                            {quickActions.map((action) => (
                                <Link
                                    key={action.label}
                                    to={action.href}
                                    className="group -mb-px -mr-px flex h-full items-center justify-between gap-3 border-b border-r border-border px-5 py-4 no-underline transition-colors hover:bg-muted/50"
                                >
                                    <span className="text-sm text-muted-foreground transition-colors group-hover:text-foreground">
                                        {action.label}
                                    </span>
                        ...
                        {managementSections.map((section) => {
                            ...
                            return (
                                <Link
                                    key={section.label}
                                    to={section.href}
                                    className="group -mb-px -mr-px flex items-center justify-between gap-3 border-b border-r border-border px-5 py-3 no-underline transition-colors hover:bg-muted/50"
                                >
                                    <span className="text-sm text-muted-foreground transition-colors group-hover:text-foreground">
                                        {section.label}
                                    </span>
