...
import EggTabNav from '@/components/admin/nests/EggTabNav';
import EggFormFields, {
    EggFormState,
    eggToFormState,
    formToEggPayload,
} from '@/components/admin/nests/EggFormFields';
    ...
    const onDelete = () => {
        ...
        deleteEgg(eggId)
            .then((response: any) => {
                ...
                history.push(`${adminBasePath}/nests/${response.nest_id}`);
            })
            .catch((submitError) => {
        ...
        <>
            ...
            <div className="mb-4 overflow-hidden rounded-md border border-border bg-card px-5 py-4">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                    ...
                    {' · '}
                    <Link
                        to={`${adminBasePath}/nests/${egg.nest_id}`}
            ...
            <form onSubmit={onSave} className="space-y-4">
                ...
                <SettingsFooter>
                    ...
                    <Link to={`${adminBasePath}/nests/${egg.nest_id}`} className="no-underline">
