...
import EggFormFields, { EggFormState, formToEggPayload } from '@/components/admin/nests/EggFormFields';
import { SettingsFooter } from '@/components/admin/settings/settingsLayout';
    ...
    const onSubmit = (event: React.FormEvent) => {
        ...
        createEgg(formToEggPayload(form))
            .then((response: any) => {
                ...
                history.push(`${adminBasePath}/nests/eggs/${response.egg!.id}`);
            })
