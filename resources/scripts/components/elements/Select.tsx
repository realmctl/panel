...
const Select = styled.select<Props>`
    ${tw`shadow-none block px-3 py-2 pr-8 rounded border w-full text-sm transition-colors duration-150 ease-linear`};
    ...
    ${(props) =>
        ...
        css`
            ${tw`bg-realm-surface border-realm-border text-realm-text`};
