...
const checkboxStyle = css<Props>`
    ${tw`bg-realm-surface cursor-pointer appearance-none inline-block align-middle select-none flex-shrink-0 w-4 h-4 text-cyan-400 border border-realm-border rounded-sm`};
    color-adjust: exact;
