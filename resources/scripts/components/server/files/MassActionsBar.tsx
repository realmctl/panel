                ...
                <Portal>
                    <div className={'pointer-events-none fixed bottom-0 mb-6 flex justify-center w-full z-50'}>
                        <Fade timeout={75} in={selectedFiles.length > 0} unmountOnExit>
                            <div
                                className={
                                    'flex items-center gap-3 pointer-events-auto rounded-lg px-4 py-3 border border-realm-border bg-realm-card/95 backdrop-blur-sm shadow-lg'
                                }
                            >
                                <span className={'text-xs text-neutral-500 pr-1'}>
