...
export const WorkspaceWelcome = React.forwardRef<HTMLDivElement, WorkspaceWelcomeProps>(
    ({ userName, videoThumbnail, videoTitle, videoDescription, actions, onPlayVideo, className }, ref) => {
        return (
            <motion.div
                ref={ref}
                className={cn('flex w-full max-w-2xl flex-col items-center gap-8 rounded-lg p-4', className)}
